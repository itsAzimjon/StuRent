                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            >
                                <img
                                    src="/assets/admin/img/icon/calendar.png"
                                    alt="User Image"
                                />
                            </span>
                            <div class="dash-count">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            >
                                <img
                                    src="/assets/admin/img/icon/chart.png"
                                    alt="User Image"
                                />
                            </span>
                            <div class="dash-count">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="section-heading">
                    <h5 class="mb-0">
                        Today’s Appointment
                        <span class="num-circle">12</span>
                    </h5>
                </div>
            </div>
            <div class="col-md-6 text-end">
                <div
                    class="owl-nav slide-nav-3 text-end nav-control"
                ></div>
            </div>
            <div class="col-md-12">
                <hr class="mt-0" />
                <div
                    class="owl-carousel appointment-slider owl-theme"
                >
                    <div class="item">
                        <div class="appointment-item">
                            ...
                            <div class="app-user">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div
                                            class="app-img justify-content-sm-end"
                                        >
                                            <img
                ...
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto d-flex">
                                <div
                                    class="bookingrange btn btn-white btn-sm"
                                >
                                    <div class="cal-ico">
                                        <span>Select Date</span>
                                        <i
                                            class="feather-chevron-down ms-1"
                                        ></i>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table
                                class="table table-borderless hover-table"
                            >
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-badge-grey text-success"
                                                ><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-badge-grey text-danger"
                                                ><i
                                                    class="fas fa-circle me-1"
                                                ></i>
                                                Disabled</span
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <a
                                                    class="avatar-pos avatar-online"
                                                    href="profile.html"
                                                    ><img
                                                        class="avatar avatar-img"
                                                        src="/assets/admin/img/profiles/avatar-05.jpg"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                                <a
                                                    class="avatar-pos avatar-offline"
                                                    href="profile.html"
                                                    ><img
                                                        class="avatar avatar-img"
                                ...
                                <tbody>
                                    <tr class="speciality-item">
                                        <td class="spl-name">
                                            <div class="spl-box">
                                                <img
                                                    src="/assets/admin/img/icon/urology.png"
                                                    alt="User Image"
                                                />
                                            </div>
                                            <div class="spl-count">
                                    ...
                                    <tr class="speciality-item">
                                        <td class="spl-name">
                                            <div class="spl-box">
                                                <img
                                                    src="/assets/admin/img/icon/neurology.png"
                                                    alt="User Image"
                                                />
                                            </div>
                                            <div class="spl-count">
                                    ...
                                    <tr class="speciality-item">
                                        <td class="spl-name">
                                            <div class="spl-box">
                                                <img
                                                    src="/assets/admin/img/icon/ortho.png"
                                                    alt="User Image"
                                                />
                                            </div>
                                            <div class="spl-count">
                                    ...
                                    <tr class="speciality-item">
                                        <td class="spl-name">
                                            <div class="spl-box">
                                                <img
                                                    src="/assets/admin/img/icon/cardio.png"
                                                    alt="User Image"
                                                />
                                            </div>
                                            <div class="spl-count">
                                    ...
                                    <tr class="speciality-item">
                                        <td class="spl-name">
                                            <div class="spl-box">
                                                <img
                                                    src="/assets/admin/img/icon/dental.png"
                                                    alt="User Image"
                                                />
                                            </div>
                                            <div class="spl-count">
                    ...
                    <div class="card-body up-content">
                        <div class="nav nav-tabs">
                            <div class="nav nav-tabs upcomimg-app">
                                <div
                                    class="pricing-carousel owl-carousel owl-theme"
                                >
                                    <div class="item">
                                        <div
                                            class="price-list active"
                                        >
                                            <a
                                                class="active"
                                                data-bs-toggle="tab"
                            ...
                            <div class="con-name">
                                <div class="flag-box">
                                    <img
                                        ...
                                        src="/assets/admin/img/flags/flag-01.png"
                                        alt="User Image"
                                    />
                                </div>
                                <div class="flag-name">
                        ...
                        <div class="country-item">
                            <div class="con-name">
                                <div class="flag-box">
                                    <img
                                        class="rounded-circle"
                                        src="/assets/admin/img/flags/flag-02.png"
                                        alt="User Image"
                                    />
                                </div>
                                <div class="flag-name">
                        ...
                        <div class="country-item">
                            <div class="con-name">
                                <div class="flag-box">
                                    <img
                                        class="rounded-circle"
                                        src="/assets/admin/img/flags/flag-03.png"
                                        alt="User Image"
                                    />
                                </div>
                                <div class="flag-name">
                        ...
                        <div class="country-item">
                            <div class="con-name">
                                <div class="flag-box">
                                    <img
                                        class="rounded-circle"
                                        src="/assets/admin/img/flags/flag-04.png"
                                        alt="User Image"
                                    />
                                </div>
                                <div class="flag-name">
                        ...
                        <div class="country-item">
                            <div class="con-name">
                                <div class="flag-box">
                                    <img
                                        class="rounded-circle"
                                        src="/assets/admin/img/flags/flag-05.png"
                                        alt="User Image"
                                    />
                                </div>
                                <div class="flag-name">
