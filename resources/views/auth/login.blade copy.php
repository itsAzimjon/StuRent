            ...
            <div class="form-wrapper">
                ...
                <form action="#" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        <label for="name">Tel (901234567)</label>
                        <input type="text" name="name" class="form-control b-radius--capsule" id="name"  placeholder="Ismingiz">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control b-radius--capsule" id="username" value="admin" placeholder="Telefon">
                        <i class="las la-user input-icon"></i>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" class="form-control b-radius--capsule" id="pass" value="admin" placeholder="Parol">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_confirmation" class="form-control b-radius--capsule" id="pass" value="admin" placeholder="Parol">
                        <i class="las la-lock input-icon"></i>
                    </div>
