            ...
            <div class="form-wrapper">
                ...
                <form action="{{ route('login') }}" method="POST" class="cmn-form mt-30">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" maxlength="9" name="email" class="form-control b-radius--capsule" id="username" value="admin" placeholder="Telefon">
                    ...
                    <div class="form-group d-flex justify-content-between align-items-center">
                        ...
                        <a href="/register" class="text-muted text--small"><i class="las la-phone"></i>Ro'yxatdan o‘tish</a>
                    </div>
                    <div class="form-group">
