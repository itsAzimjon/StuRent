...
<section class="pt-100 pb-100 section--bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form method="POST" action="/edit/save/{{$elon->id}}" class="apply-form p-sm-5 p-3 rounded-3 box--shadow"
                        ...
                        <div class="form-group col-lg-8" id="#">
                            <div class="row">
                                ...
                                <div class="col-4" style="position: relative;">
                                    ...
                                    z-index:88099;
                                    border-radius: 999px;">
                                        <a style="color: #fff;" href="/rasm/delete/{{$elon->id}}/{{$key}}">{{__('key.delete')}}</a>
                                    </div>
                                </div>
                                @endforeach
                            </div>
                       ...
                       <div class="form-group col-lg-12 text-center" >
                        ...
                        <div class="col-lg-12 mt-5 row">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="number" name="xona_soni" value="{{$elon->xona_soni}}" autocomplete="off" value=""
                                    placeholder="{{__('key.xonalar_soni')}}" class="form--control" required="">
                            </div>

                            <div class="form-group col-lg-3">
                                <label>{{__('key.um_narx')}} <sup class="text--danger">*</sup></label>
                                <input type="number" name="narx" value="{{$elon->narx}}" autocomplete="off" value="" placeholder="Sum"
                                    class="form--control" required="">
                            </div>
                            <div class="form-group col-lg-3">
                                <label>{{__('key.talaba_soni')}} <sup class="text--danger">*</sup></label>
                                <input type="number" name="talaba_soni" value="{{$elon->talaba_soni}}"  autocomplete="off" value="" placeholder="{{__('key.talaba_soni')}} "
                                    class="form--control" required="">
                            </div>
                            <div class="form-group col-lg-3">
                                <div class="form-check">
                                    ...
                                    @if($elon->kimga==1)
                                    checked 
                                    @endif type="radio" name="kimga" id="kim1" value="1">
                                ...
                                <div class="form-check">
                                    ...
                                    checked 
                                    @endif
                                    class="form-check-input" type="radio" name="kimga" id="kim2" value="2">
                                ...
                                <div class="form-check">
                                    ...
                                    checked 
                                    @endif
                                    class="form-check-input" type="radio" name="kimga" id="kim3" value="3">
                        ...
                        <div class="col-lg-12 mt-5 row">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" name="name" value="{{$elon->name}}" autocomplete="off" value=""
